...
|---|---|---|
| [Wrong Hosts File IP Entry](dns-hosts-wrong-ip-entry.md) | Application hostname points to the wrong IP address in `/etc/hosts` | Hosts file, wrong IP, curl failure |
